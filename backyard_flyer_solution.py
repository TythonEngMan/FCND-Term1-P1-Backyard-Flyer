...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        """
        # print(self.local_position[0], self.local_position[1], self.local_position[2])
    ...
    def calculate_box(self):
        ...
        local_waypoints = [[10.0, 0.0, 3.0] + self.initial_position, [10.0, 10.0, 3.0] + self.initial_position, [0.0, 10.0, 3.0] + self.initial_position, [0.0, 0.0, 3.0] + self.initial_position]
    ...
    def arming_transition(self):
        ...
        self.initial_position = self.local_position
        self.flight_state = States.ARMING
    ...
    def landing_transition(self):
        ...
        print('Error',np.linalg.norm(self.local_position[0:2] - self.initial_position[0:2]))
